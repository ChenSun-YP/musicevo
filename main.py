...
msd_subset_path = '/Users/bytedance/Downloads/musicevo/MillionSongSubset/'
os.chdir(r"/Users/bytedance/Downloads/musicevo/MillionSongSubset/")
...
# CHANGE IT TO YOUR LOCAL CONFIGURATION
msd_code_path = '/Users/bytedance/Downloads/musicevo'
...
print
'number of song files:', apply_to_all_files(msd_subset_data_path)
...
t2 = time.time()
print
'all artist names extracted in:', strtimedelta(t1, t2)

# let's see some of the content of 'all_artist_names'
print
'found', len(all_artist_names), 'unique artist names'
for k in range(5):
  print
  list(all_artist_names)[k]
...
t2 = time.time()
print
'all artist names extracted (SQLite) in:', strtimedelta(t1, t2)
# we close the connection to the database
conn.close()
# let's see some of the content
for k in range(5):
  print
  all_artist_names_sqlite[k][0]
...
most_pop_aid = sorted(files_per_artist,
                      ...
                      reverse=True)[0]
print
most_pop_aid, 'has', files_per_artist[most_pop_aid], 'songs.'
...
'SQL query:', q
print
'name(s) of the most popular artist:', pop_artist_names
...
t2 = time.time()
print
'found most popular artist in', strtimedelta(t1, t2)
print
sorted(pop_artists, key=lambda x: x[2], reverse=True)[0]